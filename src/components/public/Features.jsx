...
import { FaGoogle, FaRegCalendarPlus } from "react-icons/fa6";
  ...
  return (
    ...
    >
      <div className="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
        <h2 className="my-5 text-lg font-medium tracking-tight text-indigo-500 uppercase">
          Özelliklerimiz
        </h2>
        <h3 className="max-w-2xl px-5 mt-2 text-2xl font-black leading-tight text-center text-gray-900 sm:mt-0 sm:px-0 sm:text-4xl">
          Toplantılarınızı kolayca oluşturun ve katılımcılarınızı davet edin.
        </h3>
        <div className="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20">
          <div className="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
            <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
              ...
              <SlCalender className="relative w-20 h-20 text-indigo-500" />
              <h4 className="relative mt-6 text-lg font-bold">
                Takvim Etkinlikleri
              </h4>
              <p className="relative mt-2 text-base text-center text-gray-600">
                Takvim etkinliklerinizi kolayca oluşturun ve katılımcılarınızı
                davet edin.
              </p>
            </div>
          </div>
          ...
          <div className="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
            <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
              ...
              <FaRegCalendarPlus className="relative w-20 h-20 text-indigo-500" />
              <h4 className="relative mt-6 text-lg font-bold">
                Toplantı Oluşturma
              </h4>
              <p className="relative mt-2 text-base text-center text-gray-600">
                Müşterileriniz ve ekip üyelerinizle toplantıları kolaylıkla
                planlayın.
              </p>
            </div>
          </div>
          ...
          <div className="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3">
            <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
              ...
              <FaGoogle className="relative w-20 h-20 text-indigo-800" />
              <h4 className="relative mt-6 text-lg font-bold">Google Takvim</h4>
              <p className="relative mt-2 text-base text-center text-gray-600">
                Google takviminize kolayca erişin ve toplantılarınızı planlayın.
              </p>
            </div>
          </div>
        </div>
